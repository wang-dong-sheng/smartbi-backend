...
(
    ...
    num          int          default 2                 not null comment '能调接口的次数',
    vip          int          default 0                 not null
)
...
(
    ...
    status      varchar(128) default 'wait'            not null comment 'wait,running,success,failed',
    execMassage text                                   null comment '执行信息'
)
